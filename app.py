...
# Page config
st.set_page_config(page_title="EchoDraft (Text Version)", layout="wide")
...
st.title("EchoDraft – Text-Based Memoir Builder")

# Step 1: Memory input
st.header("1. Write or Paste Your Memory")
memory_text = st.text_area("Memory Text", placeholder="Write or paste your memory here...", height=200)
